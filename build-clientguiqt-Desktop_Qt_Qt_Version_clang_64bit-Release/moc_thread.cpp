...
#include "../client/clientguiqt/thread.h"
...
QT_MOC_LITERAL(1, 7, 10), // "appendtext"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 1), // "s"
QT_MOC_LITERAL(4, 21, 9), // "sdcSignal"
QT_MOC_LITERAL(5, 31, 2) // "sd"

    },
    "Thread\0appendtext\0\0s\0sdcSignal\0sd"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sdcSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::appendtext)) {
                *result = 0;
            }
        }
        {
            typedef void (Thread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::sdcSignal)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Thread::appendtext(QString _t1)
{
